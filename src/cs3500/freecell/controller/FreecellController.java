...
/**
 * Interface for the freecell game controller. An implementation will work with the
 * IFreeCellModel interface to provide a game of freecell.
 * @param <K> is the class representing a card.
 */
