...
/**
 * Class to test MultiMoveFreecellModel.
 */
public class MultiMoveFreecellModelTest {
  ...
  @Before
  public void setUp() {
    basic = new MultiMoveFreecellModel();
    unstartedGame = new MultiMoveFreecellModel();
    minParameters = new MultiMoveFreecellModel();
    lotsOfPiles = new MultiMoveFreecellModel();
  ...
  // testsForMultiMove
  @Test
  public void multiMoveWorksForValidMove() {
    basic.move(PileType.CASCADE, 5, 5, PileType.OPEN, 1);
    basic.move(PileType.CASCADE, 1, 6, PileType.CASCADE, 5);
    basic.move(PileType.CASCADE, 5, 4, PileType.CASCADE, 3);
    assertEquals(basic.getNumCardsInCascadePile(3), 9);
    assertEquals(basic.getNumCardsInCascadePile(5), 4);
  }

  // testsForMultiMove
  @Test(expected = IllegalArgumentException.class)
  public void multiMoveBreaksWhenMovingTooManyCards() {
    basic.move(PileType.CASCADE, 5, 5, PileType.OPEN, 1);
    basic.move(PileType.CASCADE, 6, 5, PileType.OPEN, 0);
    basic.move(PileType.CASCADE, 1, 6, PileType.CASCADE, 5);
    basic.move(PileType.CASCADE, 5, 4, PileType.CASCADE, 3);
  }
}
